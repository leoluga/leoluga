...
I am a graduated Aerospace Engineer at the Aeronautics Institute of Technology (ITA), currently a **Master's student in Physics**, with a strong academic background and hands-on experience in programming and engineering. I am passionate about space technology, quantitative finance, and software development. My journey is driven by curiosity and a desire to apply my skills to real-world challenges. Currently, I currently work as a **GNC Researcher** at IEAv, developing high-fidelity 6DOF flight simulators in C++, and as a **Freelance Quantitative Developer**, building full-stack data analysis platforms with Python (Dash, SQLite) and API integrations.

- **🎓 M.S. in Physics:** Aeronautics Institute of Technology (ITA) | *Present*
- **🚀 B.S. in Aerospace Engineering:** Aeronautics Institute of Technology (ITA) (GPA: 8.9) - Graduation Date: Dec 2024
...
## 🔧 Work Experience
### GNC Researcher | IEAv (Advanced Studies Institute)
**Mar 2024 - Present**
-   Developing 6DOF simulation models (C++) for rockets and hypersonic vehicles.
-   Researching and modeling aerodynamic stability coefficients from NASA/NACA technical reports.
-   Co-designed and deployed a team development server (Ubuntu LTS, Gitea, Samba).

### Freelance Quantitative Developer
**Aug 2025 - Present**
-   Architecting a full-stack quantitative analysis platform using Python (Dash) and SQLite3.
-   Building a data ingestion pipeline from the Ivolatility API for financial data management.
-   
...
### Intern at Legacy Capital’s Volatility Table | Apr 2023 - Dec 2024
...
## 📚 Education
-   **M.S. in Physics** - Aeronautics Institute of Technology (ITA) | *Present*
-   **B.S. in Aerospace Engineering** - Aeronautics Institute of Technology (ITA) | *GPA: 8.9/10.0*
-   **C2 Level English Certification** - Cultural Exchange, South Africa
